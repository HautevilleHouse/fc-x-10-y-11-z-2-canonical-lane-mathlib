/-!
# Reviewer Bridge — Generalized Fermat-Catalan (x^10+y^11=z^2)
...
def reviewerBridgeAssumptions : List BridgeAssumption := [
  { label := "bridge_structural", statement := "Structural projection bridge for Generalized Fermat-Catalan (x^10+y^11=z^2)" }
]
