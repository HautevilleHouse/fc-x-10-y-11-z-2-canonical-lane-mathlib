/-!
# fc-x-10-y-11-z-2 Lean migration boundary
...
`fc_x_10_y_11_z_2/SourcePackage.lean`.
...
def sourceRepository : String := "fc-x-10-y-11-z-2"
def sourceUrl : String := "https://github.com/HautevilleHouse/fc-x-10-y-11-z-2"
def sourceDescription : String := "Canonical-lane closure package for the Generalized Fermat-Catalan (x^10+y^11=z^2): admissible-class formulation, projection gates, and carried remainder."
def sourceClassification : String := "abstract_math_theorem_repo"
def sourceTopics : List String := ["fc-x-10-y-11-z-2", "canonical-lane", "admissible-class", "mathematical-proof", "reproducibility"]
